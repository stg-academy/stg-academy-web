    ...
    return (
        <div className="max-w-md mx-auto">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-2">사용자명: <strong>{displayUsername}</strong></p>
                {selectedUser && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full border bg-gray-200 rounded-lg px-3 py-2 focus:outline-none border-gray-300"
                        disabled
                    />
                </div>
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full mt-6 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
