...
import {createAttendanceWithCode, getMyAttendanceByLecture} from '../services/attendanceService';
                ...
                <section>
                    ...
                    {todaysLectures.length > 0 ? (
                        todaysLectures.map((lecture) => {
                            ...
                            return (
                                <Card key={lecture.id}
                                      className={`mb-3 bg-white space-y-4 ${isAlreadyChecked ? 'border-success/20 ' : 'border-accent/20'} `}>
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <span
                                                className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium border ${attendanceStatus.className} ${attendanceStatus.bgColor} ${attendanceStatus.borderColor}`}>
                                    ...
                                    {showCodeInput[lecture.id] ? (
                                        ...
                                        <div className="space-y-3">
                                            <div className="text-center">
                                                <p className="text-sm font-medium text-neutral-700 mb-2">출석 인증코드를
                                                    입력하세요</p>
                                                <input
                                                    type="text"
