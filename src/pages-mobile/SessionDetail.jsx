...
import {
    getMyCertificationDownload,
    getMyCertificationPreview,
    getMyCertifications
...
export default function SessionDetail() {
    ...
    const {
        ...
        cardBg,
        accentText
    } = getCourseStatusBadge(sessionInfo?.course_status);
                            ...
                            {lectures
                              ...
                              <span className="text-sm font-medium text-neutral-500 mr-2 flex-shrink-0">
                                {index + 1}회차
                                                    ...
                                                    <div
                                                        className="flex items-center text-sm text-neutral-600 space-x-4">
                                                ...
                                                <div className="flex items-center space-x-2 flex-shrink-0">
                                                    ...
                                                    <span
                                                        className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium border ${status?.className} ${status?.bgColor} ${status?.borderColor}`}>
                              {icon}
                                                        <span className="ml-1">
                                {status?.label || '미확인'}
                              </span>
                                 ...
                                 출석 체크
                                            ...
                                            {attendance?.created_at && (
                                                <div className="mt-2 text-xs text-neutral-500 truncate">
                                                    체크
                                                    시간: {formatDate(attendance.created_at)} {formatTime(attendance.created_at)}
                                                </div>
                                            )}
                                        </Card>
                                    );
